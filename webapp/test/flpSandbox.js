		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Customers",
									"targetURL": "#commsbnwcustomers-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commsbnwcustomers-display": {
								"semanticObject": "commsbnwcustomers",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.msb.nwcustomers",
									"url": sap.ui.require.toUrl("com/msb/nwcustomers")
								}
							}
						}
					}
